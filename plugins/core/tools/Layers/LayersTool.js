                    ...
                    if (
                        ...
                        expressionSettings = [
                            ...
                            `<li class="tileCogExpression">`,
                                '<div>',
                                    `<input class="tileexpression" layername="${node[i].name}" type="text" value="${currentExpression}" placeholder="e.g., b1*2">`,
                                    '<div class="expression-buttons">',
                                        `<button class="tileexpressionapply" layername="${node[i].name}">Apply</button>`,
                                    '</div>',
                                '</div>',
                                '<div>',
                                    '<div class="expression-helper-text">Use bX for bands (e.g., b1, b2). Supports math operators: +, -, *, /, () for grouping. For RGB output: b1;b2;b3. The older asset_bX spelling is still accepted and is rewritten to bX.</div>',
